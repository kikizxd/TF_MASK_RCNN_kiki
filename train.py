...
class ShapesConfig(Config):    
    ...
    NUM_CLASSES = 2 + 1  # background + 1 shapes  
...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):        
        ...
        self.add_class("shapes", 2, "orange")
...
# Load and display random samples# image_ids = np.random.choice(dataset_train.image_ids, 4)
...
# pass a regular expression to select which layers to# train by name pattern.
model.train(dataset_train, dataset_val,            
